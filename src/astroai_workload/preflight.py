...
from astroai_workload.canfar_ops import CanfarOps, parse_probe_logs
from astroai_workload.settings import ManagerSettings, manager_pod_ip, ray_probe_ports
...
def _persist_preflight(
    ...
    from astroai_workload.ray_cluster import ray_address
